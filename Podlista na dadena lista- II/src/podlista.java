...
public class podlista {
	...
	public static void main(String[] args) throws IOException {
		...
		System.err.println(isPodlista(prva,vtora));
	}

	private static boolean isPodlista(SLL<Integer> prva, SLL<Integer> vtora) {
		// TODO Auto-generated method stub
		SLLNode<Integer> dviziprva=prva.getFirst();
		SLLNode<Integer> pred=prva.getFirst();
		SLLNode<Integer> dvizivtora=vtora.getFirst();
		boolean isEdnakvi=true;
		while(dviziprva!=null) {
			isEdnakvi=true;
			dvizivtora=vtora.getFirst();
			pred=dviziprva;
			while(pred!=null && dvizivtora!=null) {
				if(pred.element!=dvizivtora.element) {
					isEdnakvi=false;
					break;
				}else {
					pred=pred.succ;
