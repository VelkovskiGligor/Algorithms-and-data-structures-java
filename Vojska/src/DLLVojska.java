...
public class DLLVojska {
	...
	private static DLL<Integer> vojska(DLL<Integer> lista, int a, int b, int c, int d) {
		...
		DLLNode<Integer> advizi=null;
		DLLNode<Integer> pred1=null;
		DLLNode<Integer> bdvizi=null;
		DLLNode<Integer> cdvizi=null;
		DLLNode<Integer> ddvizi=null;
		DLLNode<Integer> pred2=null;
		...
		if(pred1==null) {
			lista.setFirst(cdvizi);
			pred2.succ=advizi;
			DLLNode<Integer> tmp=ddvizi.succ;
			ddvizi.succ=bdvizi.succ;
			bdvizi.succ=tmp;
